<div id="dialog-message" class="hide">
  <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>tiket/proses_edit_booking/<?=$booking->id;?>">

    <div class="form-group">
      <label class="col-sm-3 control-label no-padding-right" for="nama-pemesan">Nama Pemesan</label>
      <div class="col-sm-9">
        <input type="text" id="nama-pemesan" placeholder="Nama Pemesan" name="nama" class="col-xs-12" value="<?=$booking->nama;?>" />
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="text" id="email-pemesan" placeholder="Email" name="email" class="col-xs-12" value="<?=$booking->email;?>" />
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="text" id="nomor-pemesan" placeholder="Nomor Telpon" name="no_telp" class="col-xs-12" value="<?=$booking->no_telp;?>" />
      </div>
    </div>
